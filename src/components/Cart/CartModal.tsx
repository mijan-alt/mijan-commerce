...
export function CartModal() {
  ...
  console.log('CartModal render', { cart })
            ...
            <div className="flex flex-col justify-between w-full">
              <ul className="grow overflow-auto py-4">
                {cart?.items?.map((item, i) => {
                  ...
                  // All price data comes from itemData — baked in by beforeChange hook
                  ...
                  if (isVariant) {
                    price =
                      itemData.priceInNGN ??
                      (typeof variant === 'object' ? variant?.priceInNGN : undefined)
                          ...
                          <div className="flex flex-col items-end gap-0.5">
                            {isOnSale ? (
                              <>
                                ...
                                <Price
                                  amount={regularPrice}
                                  className="text-right text-xs text-muted-foreground line-through"
                                />
                              </>
                            ) : (
                              typeof price === 'number' && (
